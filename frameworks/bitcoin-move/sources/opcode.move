...
module bitcoin_move::opcode{
    ...
    public fun op_checksigadd() : u8 {
        ...
        /// Synonym for OP_RETURN.
    const OP_RETURN_187:u8 = 0xbb;
    public fun op_return_187() : u8 {
        OP_RETURN_187
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_188:u8 = 0xbc;
    public fun op_return_188() : u8 {
        OP_RETURN_188
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_189:u8 = 0xbd;
    public fun op_return_189() : u8 {
        OP_RETURN_189
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_190:u8 = 0xbe;
    public fun op_return_190() : u8 {
        OP_RETURN_190
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_191:u8 = 0xbf;
    public fun op_return_191() : u8 {
        OP_RETURN_191
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_192:u8 = 0xc0;
    public fun op_return_192() : u8 {
        OP_RETURN_192
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_193:u8 = 0xc1;
    public fun op_return_193() : u8 {
        OP_RETURN_193
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_194:u8 = 0xc2;
    public fun op_return_194() : u8 {
        OP_RETURN_194
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_195:u8 = 0xc3;
    public fun op_return_195() : u8 {
        OP_RETURN_195
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_196:u8 = 0xc4;
    public fun op_return_196() : u8 {
        OP_RETURN_196
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_197:u8 = 0xc5;
    public fun op_return_197() : u8 {
        OP_RETURN_197
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_198:u8 = 0xc6;
    public fun op_return_198() : u8 {
        OP_RETURN_198
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_199:u8 = 0xc7;
    public fun op_return_199() : u8 {
        OP_RETURN_199
    }

        /// Synonym for OP_RETURN.
    const OP_RETURN_200:u8 = 0xc8;
    public fun op_return_200() : u8 {
        OP_RETURN_200
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_201:u8 = 0xc9;
    public fun op_return_201() : u8 {
        OP_RETURN_201
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_202:u8 = 0xca;
    public fun op_return_202() : u8 {
        OP_RETURN_202
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_203:u8 = 0xcb;
    public fun op_return_203() : u8 {
        OP_RETURN_203
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_204:u8 = 0xcc;
    public fun op_return_204() : u8 {
        OP_RETURN_204
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_205:u8 = 0xcd;
    public fun op_return_205() : u8 {
        OP_RETURN_205
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_206:u8 = 0xce;
    public fun op_return_206() : u8 {
        OP_RETURN_206
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_207:u8 = 0xcf;
    public fun op_return_207() : u8 {
        OP_RETURN_207
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_208:u8 = 0xd0;
    public fun op_return_208() : u8 {
        OP_RETURN_208
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_209:u8 = 0xd1;
    public fun op_return_209() : u8 {
        OP_RETURN_209
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_210:u8 = 0xd2;
    public fun op_return_210() : u8 {
        OP_RETURN_210
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_211:u8 = 0xd3;
    public fun op_return_211() : u8 {
        OP_RETURN_211
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_212:u8 = 0xd4;
    public fun op_return_212() : u8 {
        OP_RETURN_212
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_213:u8 = 0xd5;
    public fun op_return_213() : u8 {
        OP_RETURN_213
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_214:u8 = 0xd6;
    public fun op_return_214() : u8 {
        OP_RETURN_214
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_215:u8 = 0xd7;
    public fun op_return_215() : u8 {
        OP_RETURN_215
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_216:u8 = 0xd8;
    public fun op_return_216() : u8 {
        OP_RETURN_216
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_217:u8 = 0xd9;
    public fun op_return_217() : u8 {
        OP_RETURN_217
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_218:u8 = 0xda;
    public fun op_return_218() : u8 {
        OP_RETURN_218
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_219:u8 = 0xdb;
    public fun op_return_219() : u8 {
        OP_RETURN_219
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_220:u8 = 0xdc;
    public fun op_return_220() : u8 {
        OP_RETURN_220
    }

        /// Synonym for OP_RETURN.
    const OP_RETURN_221:u8 = 0xdd;
    public fun op_return_221() : u8 {
        OP_RETURN_221
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_222:u8 = 0xde;
    public fun op_return_222() : u8 {
        OP_RETURN_222
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_223:u8 = 0xdf;
    public fun op_return_223() : u8 {
        OP_RETURN_223
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_224:u8 = 0xe0;
    public fun op_return_224() : u8 {
        OP_RETURN_224
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_225:u8 = 0xe1;
    public fun op_return_225() : u8 {
        OP_RETURN_225
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_226:u8 = 0xe2;
    public fun op_return_226() : u8 {
        OP_RETURN_226
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_227:u8 = 0xe3;
    public fun op_return_227() : u8 {
        OP_RETURN_227
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_228:u8 = 0xe4;
    public fun op_return_228() : u8 {
        OP_RETURN_228
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_229:u8 = 0xe5;
    public fun op_return_229() : u8 {
        OP_RETURN_229
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_230:u8 = 0xe6;
    public fun op_return_230() : u8 {
        OP_RETURN_230
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_231:u8 = 0xe7;
    public fun op_return_231() : u8 {
        OP_RETURN_231
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_232:u8 = 0xe8;
    public fun op_return_232() : u8 {
        OP_RETURN_232
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_233:u8 = 0xe9;
    public fun op_return_233() : u8 {
        OP_RETURN_233
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_234:u8 = 0xea;
    public fun op_return_234() : u8 {
        OP_RETURN_234
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_235:u8 = 0xeb;
    public fun op_return_235() : u8 {
        OP_RETURN_235
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_236:u8 = 0xec;
    public fun op_return_236() : u8 {
        OP_RETURN_236
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_237:u8 = 0xed;
    public fun op_return_237() : u8 {
        OP_RETURN_237
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_238:u8 = 0xee;
    public fun op_return_238() : u8 {
        OP_RETURN_238
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_239:u8 = 0xef;
    public fun op_return_239() : u8 {
        OP_RETURN_239
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_240:u8 = 0xf0;
    public fun op_return_240() : u8 {
        OP_RETURN_240
    }

        /// Synonym for OP_RETURN.
    const OP_RETURN_241:u8 = 0xf1;
    public fun op_return_241() : u8 {
        OP_RETURN_241
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_242:u8 = 0xf2;
    public fun op_return_242() : u8 {
        OP_RETURN_242
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_243:u8 = 0xf3;
    public fun op_return_243() : u8 {
        OP_RETURN_243
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_244:u8 = 0xf4;
    public fun op_return_244() : u8 {
        OP_RETURN_244
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_245:u8 = 0xf5;
    public fun op_return_245() : u8 {
        OP_RETURN_245
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_246:u8 = 0xf6;
    public fun op_return_246() : u8 {
        OP_RETURN_246
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_247:u8 = 0xf7;
    public fun op_return_247() : u8 {
        OP_RETURN_247
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_248:u8 = 0xf8;
    public fun op_return_248() : u8 {
        OP_RETURN_248
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_249:u8 = 0xf9;
    public fun op_return_249() : u8 {
        OP_RETURN_249
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_250:u8 = 0xfa;
    public fun op_return_250() : u8 {
        OP_RETURN_250
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_251:u8 = 0xfb;
    public fun op_return_251() : u8 {
        OP_RETURN_251
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_252:u8 = 0xfc;
    public fun op_return_252() : u8 {
        OP_RETURN_252
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_253:u8 = 0xfd;
    public fun op_return_253() : u8 {
        OP_RETURN_253
    }

    /// Synonym for OP_RETURN.
    const OP_RETURN_254:u8 = 0xfe;
